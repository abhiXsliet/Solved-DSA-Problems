...
class Solution {
    public int numWaterBottles(int numBottles, int numExchange) {
        ...
        // return approach_2(numBottles, numExchange);
        // return way_2(numBottles, numExchange);
        return approach_3(numBottles, numExchange);
    }

    // TC : O(N) Where N = numBottles
    // SC : O(1)
    private static int approach_1(int numBottles, int numExchange) {
        int consumed = 0;
    ...
    // SC : O(1)
    private static int approach_2(int numBottles, int numExchange) {
    ...
    // TC : O(log(numBottles) with base numExchange)
    // SC : O(1)
    private static int way_2(int numBottles, int numExchange) {
    ...
    // TC : O(1)
    // SC : O(1)
    private static int approach_3(int numBottles, int numExchange) {
