...
private:
    ...
    // SC : O(26*26) ~= O(1)
    long long approach_1(string& source, string& target, vector<char>& original, vector<char>& changed, vector<int>& cost) {
    ...
    long long approach_2(string& source, string& target, vector<char>& original, vector<char>& changed, vector<int>& cost) {
...
public:
    long long minimumCost(string source, string target, vector<char>& original, vector<char>& changed, vector<int>& cost) {
        // return approach_1(source, target, original, changed, cost);
        return approach_2(source, target, original, changed, cost);
    }
};